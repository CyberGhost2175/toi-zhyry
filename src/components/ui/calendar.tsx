  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 rounded-md [&:has([aria-selected])]:bg-transparent",
        day_button: cn(
          "size-8 p-0 font-normal rounded-md transition-colors",
          "aria-selected:opacity-100 hover:bg-transparent focus:bg-transparent"
        ),
